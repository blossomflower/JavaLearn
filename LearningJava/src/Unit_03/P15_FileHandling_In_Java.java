...
//		}
	...
	void saveOutputIntoAFile() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\Anusha\\git\\JavaLearn\\LearningJava\\src\\Unit_03\\output.txt");
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	void saveLogOfProgram() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\Anusha\\git\\JavaLearn\\LearningJava\\src\\Unit_03\\log.txt",true);
		} catch (IOException e) {
			e.printStackTrace();
		}
